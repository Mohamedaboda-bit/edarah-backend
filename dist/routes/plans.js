...
router.post('/buy/:id', auth_1.authenticateToken, paymobController_1.buyPlan);
router.post('/addPlan', auth_1.authenticateToken, auth_1.requireAdmin, planController.addPlan);
